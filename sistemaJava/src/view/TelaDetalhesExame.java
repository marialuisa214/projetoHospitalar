...
public class TelaDetalhesExame extends javax.swing.JFrame {

    public TelaDetalhesExame(Exame exame, Marcada consulta, ControleDados dados){
        this.consulta = consulta;
        this.medico = consulta.getMedico();
        this.exame = exame;
        this.dados = dados;
        this.p = consulta.getPaciente().getProntuario();
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        labelCmr.setText(medico.getCrm());
        ...
        labelNomePaciente.setText(exame.getPaciente().getNome());

        labelCodigo.setText("Código:");

        labelCodigoConsulto.setText(exame.getCodigo());

        labelData.setText("Data consulta:");

        labelDataConsulta.setText(exame.getData());

        labelDescricao.setText("Descricao");

        labelDescricaoMedico.setText(exame.getResultado());
